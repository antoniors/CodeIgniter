...
class Upload_test extends CI_TestCase
{
    public function set_up()
    {
        ...
        $ci->lang = $this->getMock('CI_Lang', ['load', 'line']);
    ...
    public function test_set_upload_path()
    {
        $this->upload->set_upload_path('/tmp/');
    ...
    public function test_set_image_properties()
    {
    ...
    public function test_set_xss_clean()
    {
    ...
    public function test_is_allowed_filesize()
    {
    ...
    public function test_is_allowed_dimensions()
    {
        $this->upload->file_type = 'text/plain';
    ...
    public function test_validate_upload_path()
    {
    ...
    public function test_limit_filename_length()
    {
    ...
    public function test_do_xss_clean()
    {
        $dir = 'uploads';
        $file1 = 'file1.txt';
        $file2 = 'file2.txt';
